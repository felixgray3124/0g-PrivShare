          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="card text-center">
              ...
              <p className="text-sm text-gray-600">
                Files are automatically encrypted and stored on the 0G Storage network
              </p>
            </div>
            <div className="card text-center">
              ...
              {!isConnected ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-8">
                    You need to connect your Web3 wallet to upload files to the 0G Storage network
                  </p>
      ...
      <footer className="bg-white border-t border-gray-200 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-sm text-gray-500">
            <p>PrivShare - Decentralized Privacy File Sharing Platform on 0G Storage</p>
            <p className="mt-2">
              Files are stored on the 0G Storage network, ensuring decentralization and persistence
            </p>
          </div>
        </div>
      </footer>
